...
- [3. Старт работы](#3-старт-работы)
  ...
  - [3.2. Подключение через REST API](#32-подключение-через-rest-api)
    - [3.2.1. Получение доступа](#321-получение-доступа)
    - [3.2.2. Способ авторизации](#322-способ-авторизации)
...
- [5. Описание методов](#5-описание-методов)
  - [5.1. Swagger](#51-swagger)
  - [5.2. SDK](#52-sdk)
...
## 5. Описание методов
Сервис предоставляет набор методов для работы с данными о сотрудниках, их должностях и ролях в системе.
...
**Массовые операции**: получение списка всех сотрудников (GetPersons).
...
**Очистка**: массовое удаление всех ролей в организации (DeleteRoles).
